...
h2{ font-family: Verdana, Tahoma, Arial, sans-serif; font-size: 15pt; font-weight: bold; color: #4F81BD; }
h3{ font-size: 12pt; font-weight: bold; color: #4F81BD; }
...
<body>
	...
	<p>
		<xsl:value-of select="xs:annotation[xs:documentation][1]/xs:documentation" />
	</p>
...
<!-- /jaKa: attributes -->
	...
	<xsl:template match="xs:simpleType">
		...
		<b>Description</b>: <xsl:apply-templates select="xs:annotation" /> <br/>
...
<!-- jaKa: support for attributes -->
  <xsl:template match="xs:attribute">
    <xsl:choose>
        ...
        <tr><th>Description</th><td> <xsl:apply-templates select="xs:annotation" />&nbsp; </td></tr>
        </table>
      </xsl:when>
        ...
        <td><xsl:apply-templates select="xs:annotation" />&nbsp;</td></tr>
			</xsl:when>
      <xsl:when test="@name">
        <tr><td><xsl:value-of select="@name"/> </td>
...
<!-- /jaKa: support for attributes -->
	...
	<!--*********************************************************************-->
	<xsl:template match="xs:annotation/xs:documentation | xs:documentation">
		<span>
			<xsl:value-of select="." />
		</span>
	</xsl:template>
