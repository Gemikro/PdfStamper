            ...
            lock (_lock) {
                try {
                    if (data.Rows.Count == 0) {
                        ...
                        return new response_item_type[] { new response_item_type() { pdf_template = request.pdf_template_list.First(), data = "There is no data in the provided data table!" } };
                    }
                    ...
                    return new response_item_type[] { new response_item_type() { pdf_template = request.pdf_template_list.First(), data = String.Empty } };
                }
                catch (Exception ex) {
